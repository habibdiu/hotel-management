            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{ route('admin.advocate.add') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="text" name="barcouncil_sonod_no" class="form-control"
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="number" name="case_limit" class="form-control" placeholder="Enter Case Limit">
                                </div>
                                <div class="col-md-3 mb-3">
                                    <label for="issue_date" class="form-label">Storage Limit</label>
                                    <input type="text" name="storage_limit" class="form-control" placeholder="Enter Storage Limit ">
                                </div>
                                <div class="col-md-3 mb-3">
                                    <label for="issue_date" class="form-label">Sms Username</label>
                                    <input type="text" name="sms_username" class="form-control" placeholder="Enter Sms Username">
                                </div>
                                <div class="col-md-3 mb-3">
