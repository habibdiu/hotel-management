                            ...
                            <table id="dataTableExample" class="table" style="width: 100%;">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="">Amenities</th>
                                        <th style="">Floor Number</th>
                                        <th style="">Price</th>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ route('admin.room.edit', $single_room->id) }}" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="room_type{{ $single_room->id }}" class="form-label">Room Type*</label>
                                                                <select class="form-select" id="room_type{{ $single_room->id }}" name="room_type" required>
                                                                    <option value="">---Select---</option>
                                                                    <option value="single" {{ $single_room->room_type == 'single' ? 'selected' : '' }}>Single</option>
                                                                    <option value="double" {{ $single_room->room_type == 'double' ? 'selected' : '' }}>Double</option>
                                                                    <option value="suite" {{ $single_room->room_type == 'suite' ? 'selected' : '' }}>Suite</option>
                                                                    <option value="deluxe" {{ $single_room->room_type == 'deluxe' ? 'selected' : '' }}>Deluxe</option>
                                                                </select>
                                                            </div>
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <textarea class="form-control" 
                                                                        ...
                                                                        name="description">{{ old('description', $single_room->description) }}</textarea>
                                                            </div>
